...
import com.jlcb.vendas.services.ClienteService;
...
public class ClienteController {
	...
	@PutMapping(path = "/{id}")
	@ResponseBody
	public ResponseEntity<ClienteDTO> updateCliente(@PathVariable(name = "id") Integer id, @RequestBody ClienteDTO clienteDTO) {
		Cliente entidade = clienteService.fromDTO(clienteDTO);
	...
	public ResponseEntity<Void> deleteCliente(@PathVariable(name = "id") Integer id) {
